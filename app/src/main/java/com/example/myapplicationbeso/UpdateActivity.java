...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button updateButton;
    EditText Name, Age, Phone, ID,Email,Date,Location;
    String name,age,phone,id,email,date,loc;
    String imageUrl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Phone = findViewById(R.id.u_age);
        Age = findViewById(R.id.u_phone);
        ID = findViewById(R.id.u_ID);
        Email = findViewById(R.id.u_email);
        Date = findViewById(R.id.u_date);
        Location = findViewById(R.id.u_location);
    ...
    public void updateData(){
        ...
        DataClass dataClass = new DataClass(name, age,phone,id,email,date,loc, imageUrl);
